...
inline int UseCamera()
{
    ...
    GLuint vertexShader = UseVertexShader("../Shaders/Texture/VertexShader.glsl");
    GLuint fragmentShader = UseFragmentShader("../Shaders/Texture/FragmentShader.glsl");
    ...
    int width, height;
    unsigned char* image = SOIL_load_image("../img/container.png", &width, &height, nullptr, SOIL_LOAD_RGB);
